...
- Persist any new configurable UI control into localStorage (via `captioner_state_v1`) and keep `public/alternate-test-versions/localStorage.json` in sync as the seed/default override when defaults shift.
