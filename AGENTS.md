...
- Baseline fade defaults (fadeStart/fadeEnd/opacityGamma) should stay synced across `public/index.html`, README, and localStorage seeds when tuning reveal opacity ramps.
