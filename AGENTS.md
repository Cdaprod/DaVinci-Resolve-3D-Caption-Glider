...
- Theme toggles must flip both background and text palettes (dark=black bg/white text, light=white bg/near-black text) and persist through seeds/localStorage.
